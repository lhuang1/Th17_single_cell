...
pdf(file = paste0(dir_out, "Fig1_D_UMAP_by_tissue_", today, ".pdf"), width = 7, height = 7)
...
pdf(file = paste0(dir_out, "Fig1_E_UMAP_by_Foxp3_Mki67_", today, ".pdf"), width = 4.5, height = 7)
...
pdf(file = paste0(dir_out, "Fig1F_heatmap.pdf"),width = 4)
...
saveRDS(pdata, file = paste0(dir_out, "Fig1F_heatmap.rds"))
```
...
p <- plt_df %>% 
  ...
  # scale_color_gradient2(low = "blue", mid = "white", high = "red", na.value = "grey60") +
...
p
pdf(paste0(dir_out, "Fig1G_enrichment_", today, ".pdf"), height = 4, width = 4)
p
dev.off()
```
...
pdf(paste0(dir_out, "Fig1H_dotplot_", today, ".pdf"), height = 3, width = 7)
p
dev.off()
```
